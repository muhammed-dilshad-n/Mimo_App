...
class __$$GenericImplCopyWithImpl<$Res>
    extends _$AuthFailureCopyWithImpl<$Res, _$GenericImpl>
...
class _$GenericImpl implements _Generic {
  const _$GenericImpl(this.message);
  ...
  @override
  String toString() {
    return 'AuthFailure.generic(message: $message)';
  }
...
abstract class _Generic implements AuthFailure {
  const factory _Generic(final String message) = _$GenericImpl;
...
abstract class _Unexpected implements AuthFailure {
  const factory _Unexpected(final String error) = _$UnexpectedImpl;
